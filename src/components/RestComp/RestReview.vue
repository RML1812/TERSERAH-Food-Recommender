        ...
        <div class="lg:mx-32 md:mx-24 sm:mx-14 mx-10">
            ...
            <div>
                <div class="text-center mt-10 mb-14 font-semibold">
                    ...
                    <div @click="menuOpen()" class="h-10 mx-20 rounded-lg bg-black text-white text-center py-2 cursor-pointer hover:bg-slate-500 px-6">Review Aku!</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="font-[Poppins] bg-[#F2F2F2] text-black h-auto lg:w-[1100px] md:w-[800px] sm:w-[600px] w-[420px] sm:ml-20 ml-8 md:top-[450px] lg:top-[370px] top-[400px] absolute rounded-2xl border-spacing-60 shadow-xl">
            <div class="mb-10">    
                ...
                <div class="md:mx-20 sm:mx-10">
                    ...
                    <div class="mt-6 mb-5">
                        <form action="">
                            <textarea name="" id="" class="bg-[#D3D3D3] w-96 sm:w-full rounded-md h-56 shadow-xl border p-5 mb-7 ml-5" placeholder="Ketik Review-mu disini....." ></textarea>
                            <button class="bg-black text-white px-14 float-right py-1 rounded-2xl mb-14 mr-10">Kirim</button>
                        </form>
                    </div>
                </div>
            </div>

            ...
            <div class="popup-body p-5 grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div class="flex items-center gap-2">
                  <input disabled type="text" class="popup-input" :value="selectedReservation.waktuMulai" placeholder="Jam">
                  <span>-</span>
                  <input disabled type="text" class="popup-input" :value="selectedReservation.waktuSelesai" placeholder="Jam">
                </div>
              </div>
              ...
              <div>
                ...
                <input disabled type="text" class="popup-input" :value="selectedReservation.tanggalReservation" placeholder="DD/MM/YY">
              </div>

              <!-- Atas Nama -->
              <div>
                <label class="popup-label">Atas Nama</label>
                <input disabled type="text" class="popup-input" :value="selectedReservation.name" placeholder="Nama">
              </div>

              <!-- Jumlah Orang -->
              <div>
                <label class="popup-label">Jumlah Orang</label>
                <input disabled type="text" class="popup-input" :value="selectedReservation.jumlahOrang" placeholder="Jumlah Orang">
              </div>

              <!-- No. Handphone -->
              <div>
                <label class="popup-label">No. Handphone</label>
                <input disabled type="text" class="popup-input" :value="selectedReservation.noHP" placeholder="No. Handphone">
              </div>

              <!-- Harga -->
              <div>
                <label class="popup-label">Harga</label>
                <div class="font-bold text-lg">{{ selectedReservation.harga }}</div>
              </div>
            </div>
          </div>
        </div>
